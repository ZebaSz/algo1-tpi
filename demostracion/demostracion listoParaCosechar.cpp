...
Qc: i == _campo.dimensiones().ancho * _campo.dimensiones().largo ^ cantCosechables = | [ 1 | j <-- [0..i], estadoParcela(i) == ListoParaCosechar] |
...
I: 0 <= i <= _campo.dimensiones().ancho * _campo.dimensiones().largo ^ cantCosechables = | [ 1 | j <-- [0..i], estadoParcela(i) == ListoParaCosechar] |
...
5) cantCosechables = | [ 1 | j <-- [0..i], estadoParcela(i) == ListoParaCosechar] |
...
8) cantCosechables = | [ 1 | j <-- [0..i], estadoParcela(i) == ListoParaCosechar] |
