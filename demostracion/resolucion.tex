...
\section{listoParaCosechar}
    ...
    \subsection{Demostraci\'on}
        ...
        Por Pc, sabemos que $ cantCosechables == 0 \land i == 0$. Por lo tanto, $0 \leq i$ (porque que sea igual, implica que sea igual o mayor) y $i \leq (prm(dimensiones(campo(this))) \times sgd(dimensiones(campo(this)))$ (porque que sea mayor, implica que sea igual o mayor).
        ...
        \bigskip
        de longitud 0 (la lista est\'a vac\'ia ya que y no toma ning\'un valor). Al tener longitud 0, la misma es equivalente a \\ cantCosechables, por lo que podemos afirmar
        ...
        Por I, sabemos que $\land 0 \leq i \leq (prm(dimensiones(campo(this))) \times sgd(dimensiones(campo(this)))$. Adem\'as, por $\neg$B, sabemos que $(prm(dimensiones(campo(this)) \times sgd(dimensiones(campo(this)))) \leq i$.
        ...
        \bigskip
        Por lo tanto, $x \leftarrow [0..i \div sgd(dimensiones(campo(this)))]$. Por otro lado
        ...
        \bigskip
        $x == prm(dimensiones(campo(this))) \implica i - x * sgd(dimensiones(campo(this)))) == 0 $

        $(\forall x \leftarrow [0..prm(dimensiones(campo(this))))) \ sgd(dimensiones(campo(this))) \leq i - x * sgd(dimensiones(campo(this)))) $

        \bigskip
        Es decir, podemos expresar cantCosechables como
        ...
        \bigskip
        Sin embargo, [0..0) resulta en la lista vac\'ia, por lo que la segunda lista de esta suma no tiene elementos y podemos quitarla. 
        ...
        \bigskip
        Considerando ambas variables, tenemos que
        ...
        \bigskip
        Luego, pasando la i para el otro lado, obtenemos $prm(dimensiones(campo(this)) \times sgd(dimensiones(campo(this))) \leq i$, que es exactamente $\neg$B.
